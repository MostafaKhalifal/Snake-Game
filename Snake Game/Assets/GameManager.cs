...
public class GameManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        for (int i = 0;i < 20;i++)
        {
            GameObject new_obs = Instantiate(Obs);
            int x, z;
            ...
            do {
                ...
                if (x > -level_width / 4 && x < level_width / 4 && z > -level_height / 4 && z < level_height / 4) valid = false;  
            }
            while(valid == false);

            new_obs.transform.position = new Vector3(x, 0, z);
            new_obs.transform.localScale = new Vector3(Random.Range(1, 4), 1, Random.Range(1, 4));
